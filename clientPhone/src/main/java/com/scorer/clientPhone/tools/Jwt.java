    ...
    public Map<String, Object> validToken(String token, String uid, RedisTemplate<String, String> redisTemplate) {
        ...
        try {
            ...
            if (jwsObject.verify(verifier)) {
                ...
                resultMap.put("state", com.scorer.clientPhone.tools.TokenState.VALID.toString());
                ...
                if (jsonOBj.containsKey("ext")) {
                    ...
                    if (tokens == null) {
                        resultMap.clear();
                        resultMap.put("state", com.scorer.clientPhone.tools.TokenState.EXPIRED.toString());
                    ...
                    // 校验失败
                    resultMap.put("state", com.scorer.clientPhone.tools.TokenState.INVALID.toString());
                }
            } else {
                // 校验失败
                resultMap.put("state", com.scorer.clientPhone.tools.TokenState.INVALID.toString());
