...
public class CheckWebManagerTokenFilter implements GatewayFilter, Ordered {
...
//            }
            ...
            String uid = headers.getFirst("managerId");
            String uid_token = operations.get("uid_school_token:" + uid);
