...
public class ScorerURI {
    ...
    private static void initNeedAppCheckScorerAdminToken(){
        ...
        NeedAppCheckScorerAdminToken.add(ScorerAdmin.GetSeasonShowsList);
        NeedAppCheckScorerAdminToken.add(ScorerAdmin.DeleteZoneByZoneId);
        NeedAppCheckScorerAdminToken.add(ScorerAdmin.UpdateZoneInfo);
        NeedAppCheckScorerAdminToken.add(ScorerAdmin.CreateZone);
        NeedAppCheckScorerAdminToken.add(ScorerAdmin.AddSeasonToZone);
        NeedAppCheckScorerAdminToken.add(ScorerAdmin.DelSeasonFromZone);
        NeedAppCheckScorerAdminToken.add(ScorerAdmin.GetZoneInfoByZoneId);
        NeedAppCheckScorerAdminToken.add(ScorerAdmin.GetSeasonResultBySeasonId);
        NeedAppCheckScorerAdminToken.add(ScorerAdmin.UpdateSeasonResult);
        NeedAppCheckScorerAdminToken.add(ScorerAdmin.GetZoneInfoByName);
        NeedAppCheckScorerAdminToken.add(ScorerAdmin.DelSeason);
        NeedAppCheckScorerAdminToken.add(ScorerAdmin.ManualGameOverSeason);
        NeedAppCheckScorerAdminToken.add(ScorerAdmin.MergeZone);
    }

    private static void initNeedAppCheckURI(){
        setAllURI(NeedAppCheckURI,ScorerAppGroup.class);
        setAllURI(NeedAppCheckURI,ScorerAppLogin.class);
        setAllURI(NeedAppCheckURI,ScorerAppMainPage.class);
        setAllURI(NeedAppCheckURI,ScorerAppMainPageV3.class);
        setAllURI(NeedAppCheckURI,ScorerAppSeason.class);
        setAllURI(NeedAppCheckURI,ScorerAppTV.class);
        setAllURI(NeedAppCheckURI,ScorerAppUser.class);
        setAllURI(NeedAppCheckURI,ScorerAppZone.class);
    }

    private static void initNeedAppCheckAppToken(){
        setAllURI(NeedAppCheckAppToken,ScorerAppGroup.class);
        setAllURI(NeedAppCheckAppToken,ScorerAppSeason.class);
        {
            NeedAppCheckAppToken.add(ScorerAppZone.CreateZone);
            NeedAppCheckAppToken.add(ScorerAppZone.ModifyZone);
            NeedAppCheckAppToken.add(ScorerAppZone.ModifyTeamInZone);
            NeedAppCheckAppToken.add(ScorerAppZone.GetMyZoneArray);
            NeedAppCheckAppToken.add(ScorerAppZone.CreateSeasonInZone);
            NeedAppCheckAppToken.add(ScorerAppZone.FindRecorderUidByPhone);
            NeedAppCheckAppToken.add(ScorerAppZone.FindTeamsByTeamName);
            NeedAppCheckAppToken.add(ScorerAppZone.FindTeamsInfoByZoneId);
            NeedAppCheckAppToken.add(ScorerAppZone.GetTeamsInfoByZoneId);
            NeedAppCheckAppToken.add(ScorerAppZone.CheckSeason);
            NeedAppCheckAppToken.add(ScorerAppZone.ChangeTeamLogo);
            NeedAppCheckAppToken.add(ScorerAppZone.CreateTeamInZone);
            NeedAppCheckAppToken.add(ScorerAppZone.DelTeamInZone);
            NeedAppCheckAppToken.add(ScorerAppZone.DelUserInZone);
            NeedAppCheckAppToken.add(ScorerAppZone.InvitationManage);
            NeedAppCheckAppToken.add(ScorerAppZone.GetZoneManagerList);
            NeedAppCheckAppToken.add(ScorerAppZone.DelZoneManager);
            NeedAppCheckAppToken.add(ScorerAppZone.GetTeamInfoInZone);
            NeedAppCheckAppToken.add(ScorerAppZone.AddPlayerToZoneTeam);
        }
        {
            NeedAppCheckAppToken.add(ScorerAppUser.SaveUserInfo);
            NeedAppCheckAppToken.add(ScorerAppUser.GetUserInfo);
            NeedAppCheckAppToken.add(ScorerAppUser.GetUserFeats);
            NeedAppCheckAppToken.add(ScorerAppUser.GetUserPerformance);
            NeedAppCheckAppToken.add(ScorerAppUser.GetUserCareer);
            NeedAppCheckAppToken.add(ScorerAppUser.GetUserCareerMax);
            NeedAppCheckAppToken.add(ScorerAppUser.FindUserList);
            NeedAppCheckAppToken.add(ScorerAppUser.FindUserByPhone);
            NeedAppCheckAppToken.add(ScorerAppUser.AddUserInZone);
        }
        {
            NeedAppCheckAppToken.add(ScorerAppLogin.Logout);
        }
        {
