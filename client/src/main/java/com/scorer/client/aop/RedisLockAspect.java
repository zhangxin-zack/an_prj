...
import com.scorer.client._DBController.RedisLock_METHOD;
import com.scorer.client._DBController.RedisLock_PARAMETER_A;
import com.scorer.client._DBController.RedisLock_PARAMETER_B;
import com.scorer.client._DBController.RedisLock_PARAMETER_C;
...
public class RedisLockAspect {
    ...
    @Pointcut("execution(* com.scorer.client..*(..)) && @annotation(com.scorer.client._DBController.RedisLock_METHOD)")
